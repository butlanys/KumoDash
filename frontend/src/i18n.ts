...
const resources = {
  en: {
    translation: {
      ...
      'dashboard.historyTitle': 'Usage History',
      'dashboard.historyRange': 'Range',
      'dashboard.historyCpu': 'CPU Usage',
      'dashboard.historyMemory': 'Memory Usage',
      'dashboard.historyDisk': 'Disk Usage',
      'dashboard.alertsTitle': 'Alerts',
      'dashboard.alertsEmpty': 'No recent alerts',
      'dashboard.alertStatusTriggered': 'Triggered',
      'dashboard.alertStatusRecovered': 'Recovered',
      'dashboard.alertMetricCpu': 'CPU',
      'dashboard.alertMetricMemory': 'Memory',
      'dashboard.alertMetricDisk': 'Disk',
      ...
      // Settings - Monitoring
      'settings.monitoring.title': 'Monitoring & Alerts',
      'settings.monitoring.description': 'Configure metrics sampling and alert thresholds',
      'settings.monitoring.sampleInterval': 'Sample Interval (seconds)',
      'settings.monitoring.sampleIntervalHint': 'How often to collect metrics (10-3600s)',
      'settings.monitoring.sampleIntervalMin': 'Sample interval must be at least 10 seconds',
      'settings.monitoring.sampleIntervalMax': 'Sample interval must be at most 3600 seconds',
      'settings.monitoring.retentionDays': 'Retention (days)',
      'settings.monitoring.retentionHint': 'How long to keep metrics data (1-90 days)',
      'settings.monitoring.retentionMin': 'Retention must be at least 1 day',
      'settings.monitoring.retentionMax': 'Retention must be at most 90 days',
      'settings.monitoring.cpuAlert': 'CPU Alert (%)',
      'settings.monitoring.cpuAlertHint': 'Trigger when CPU usage exceeds this threshold',
      'settings.monitoring.memoryAlert': 'Memory Alert (%)',
      'settings.monitoring.memoryAlertHint': 'Trigger when memory usage exceeds this threshold',
      'settings.monitoring.diskAlert': 'Disk Alert (%)',
      'settings.monitoring.diskAlertHint': 'Trigger when disk usage exceeds this threshold',
      'settings.monitoring.alertMin': 'Alert threshold must be at least 1%',
      'settings.monitoring.alertMax': 'Alert threshold must be at most 100%',
      ...
      'services.description': 'Manage systemd services and view logs',
      ...
      'services.sub': 'Sub',
      'services.descriptionCol': 'Description',
      'services.actions': 'Actions',
      'services.actionStart': 'Start',
      'services.actionStop': 'Stop',
      'services.actionRestart': 'Restart',
      'services.actionEdit': 'Edit',
      'services.logsTitle': 'Service Logs',
      'services.logsEmpty': 'No logs available',
      'services.logsSince': 'Since',
      'services.logsLimit': 'Limit',
      'services.logsFetch': 'Fetch Logs',
      'services.actionSuccess': 'Service action completed',
      'services.actionError': 'Service action failed',
      'services.searchPlaceholder': 'Search services...',
      'services.newService': 'New Service',
      'services.newServiceTitle': 'Create Service',
      'services.nameLabel': 'Service Name',
      'services.namePlaceholder': 'my-service.service',
      'services.contentLabel': 'Unit File Content',
      'services.contentPlaceholder': '[Unit]...\\n[Service]...\\n[Install]...',
      'services.create': 'Create',
      'services.createSuccess': 'Service created',
      'services.createError': 'Failed to create service',
      'services.detailsTitle': 'Service Details',
      'services.tabLogs': 'Logs',
      'services.tabEditor': 'Editor',
      'services.editorTitle': 'Unit File',
      'services.editorPath': 'Path',
      'services.editorSave': 'Save',
      'services.editorSaveSuccess': 'Unit file saved',
      'services.editorSaveError': 'Failed to save unit file',
      'services.unsavedChanges': 'You have unsaved changes. Discard them?',
      'services.enableAfterCreate': 'Enable after create',
      'services.startAfterCreate': 'Start after create',
      'services.nameInvalid': 'Service name must end with .service',
      'services.contentRequired': 'Unit file content is required',
  ...
  zh: {
    translation: {
      ...
      'dashboard.free': '可用',
      'dashboard.total': '总计',
      'dashboard.historyTitle': '使用趋势',
      'dashboard.historyRange': '时间范围',
      'dashboard.historyCpu': 'CPU 使用率',
      'dashboard.historyMemory': '内存使用率',
      'dashboard.historyDisk': '磁盘使用率',
      'dashboard.alertsTitle': '告警',
      'dashboard.alertsEmpty': '暂无告警',
      'dashboard.alertStatusTriggered': '触发',
      'dashboard.alertStatusRecovered': '恢复',
      'dashboard.alertMetricCpu': 'CPU',
      'dashboard.alertMetricMemory': '内存',
      'dashboard.alertMetricDisk': '磁盘',
      ...
      // Settings - Monitoring
      'settings.monitoring.title': '监控与告警',
      'settings.monitoring.description': '配置指标采样与告警阈值',
      'settings.monitoring.sampleInterval': '采样间隔（秒）',
      'settings.monitoring.sampleIntervalHint': '指标采样频率（10-3600 秒）',
      'settings.monitoring.sampleIntervalMin': '采样间隔至少为 10 秒',
      'settings.monitoring.sampleIntervalMax': '采样间隔最多为 3600 秒',
      'settings.monitoring.retentionDays': '保留天数',
      'settings.monitoring.retentionHint': '指标数据保留时间（1-90 天）',
      'settings.monitoring.retentionMin': '保留时间至少为 1 天',
      'settings.monitoring.retentionMax': '保留时间最多为 90 天',
      'settings.monitoring.cpuAlert': 'CPU 告警 (%)',
      'settings.monitoring.cpuAlertHint': 'CPU 使用率超过该值触发',
      'settings.monitoring.memoryAlert': '内存告警 (%)',
      'settings.monitoring.memoryAlertHint': '内存使用率超过该值触发',
      'settings.monitoring.diskAlert': '磁盘告警 (%)',
      'settings.monitoring.diskAlertHint': '磁盘使用率超过该值触发',
      'settings.monitoring.alertMin': '告警阈值至少为 1%',
      'settings.monitoring.alertMax': '告警阈值最多为 100%',
      ...
      // Services (systemd)
      'services.title': '服务',
      'services.description': '管理 systemd 服务并查看日志',
      'services.refresh': '刷新',
      'services.empty': '暂无服务',
      'services.unit': '单元',
      'services.load': '加载',
      'services.active': '活跃',
      'services.sub': '子状态',
      'services.descriptionCol': '描述',
      'services.actions': '操作',
      'services.actionStart': '启动',
      'services.actionStop': '停止',
      'services.actionRestart': '重启',
      'services.actionEdit': '编辑',
      'services.logsTitle': '服务日志',
      'services.logsEmpty': '暂无日志',
      'services.logsSince': '起始时间',
      'services.logsLimit': '条数限制',
      'services.logsFetch': '获取日志',
      'services.actionSuccess': '服务操作已完成',
      'services.actionError': '服务操作失败',
      'services.searchPlaceholder': '搜索服务...',
      'services.newService': '新增服务',
      'services.newServiceTitle': '创建服务',
      'services.nameLabel': '服务名称',
      'services.namePlaceholder': 'my-service.service',
      'services.contentLabel': 'Unit 文件内容',
      'services.contentPlaceholder': '[Unit]...\\n[Service]...\\n[Install]...',
      'services.create': '创建',
      'services.createSuccess': '服务已创建',
      'services.createError': '创建服务失败',
      'services.detailsTitle': '服务详情',
      'services.tabLogs': '日志',
      'services.tabEditor': '编辑器',
      'services.editorTitle': 'Unit 文件',
      'services.editorPath': '路径',
      'services.editorSave': '保存',
      'services.editorSaveSuccess': 'Unit 文件已保存',
      'services.editorSaveError': '保存 Unit 文件失败',
      'services.unsavedChanges': '有未保存的更改，确定要丢弃吗？',
      'services.enableAfterCreate': '创建后启用',
      'services.startAfterCreate': '创建后启动',
      'services.nameInvalid': '服务名称必须以 .service 结尾',
      'services.contentRequired': 'Unit 文件内容不能为空',
