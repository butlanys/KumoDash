...
pub fn create_router(state: AppState) -> Router {
    ...
    let protected_routes = Router::new()
        ...
        .route("/api/v1/system/metrics", get(crate::handlers::system::get_metrics))
        .route("/api/v1/system/alerts", get(crate::handlers::system::get_alerts))
        ...
        .route("/api/v1/systemd/units", get(crate::handlers::systemd::list_units))
        .route("/api/v1/systemd/units", post(crate::handlers::systemd::create_unit))
        .route("/api/v1/systemd/units/{name}/{action}", post(crate::handlers::systemd::control_unit))
        .route("/api/v1/systemd/units/{name}/file", get(crate::handlers::systemd::get_unit_file))
        .route("/api/v1/systemd/units/{name}/file", put(crate::handlers::systemd::update_unit_file))
        .route("/api/v1/systemd/units/{name}/logs", get(crate::handlers::systemd::get_logs))
